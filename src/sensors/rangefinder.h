...
namespace zestimation {
  ...
  class Rangefinder {
    ...
    private:
      ...
      zestimation::LowPassFilter _lpf = zestimation::LowPassFilter(10);
      ...
      zestimation::MadgwickQuaternionFilter6DOF _quaternionFilter = zestimation::MadgwickQuaternionFilter6DOF(BETA, ZETA);
